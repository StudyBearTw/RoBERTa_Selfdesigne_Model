...
if __name__ == "__main__":
    # 替換為你的資料集路徑
    dataset_path = r"C:\Users\user\Desktop\RoBERTa_Model_Selfdesign\DataSet\chinese_news.csv"
    text_column_name = "content"  # 使用 desc 作為文本列
    output_file_path = r"C:/Users/user/Desktop/RoBERTa_Model_Selfdesign/DataSet/cleaned_chinese_news.csv"
